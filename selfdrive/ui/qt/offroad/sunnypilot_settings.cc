...
SPControlsPanel::SPControlsPanel(QWidget* parent) : QWidget(parent) {
  ...
  QWidget* gacMain = new QWidget(this);
  QVBoxLayout* gacSub = new QVBoxLayout(this);
  QWidget* customOffsetsMain = new QWidget(this);
  QVBoxLayout* customOffsetsSub = new QVBoxLayout(this);
  QWidget* customTorqueMain = new QWidget(this);
  QVBoxLayout* customTorqueSub = new QVBoxLayout(this);
  QWidget* speedLimitMain = new QWidget(this);
...
SPVisualsPanel::SPVisualsPanel(QWidget* parent) : QWidget(parent) {
  ...
  QVBoxLayout* main_layout = new QVBoxLayout(this);
  QWidget* devUiMain = new QWidget(this);
  QVBoxLayout* devUiSub = new QVBoxLayout(this);
