...
class CarController:
  ...
  def update(self, CC, CS):
    ...
    if CarControllerParams.FEATURE_INIT_MAIN_OFF:
      if CS.persistMainDisabled:
        self.init_main_off = True
      if not self.init_main_off:
        can_sends.append(hondacan.spam_buttons_command(self.packer, 1, idx, self.CP.carFingerprint))
